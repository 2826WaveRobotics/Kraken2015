#include "AutoMode_ShootTotesNoSensor.h"
...
AutoMode_ShootTotesNoSensor::AutoMode_ShootTotesNoSensor()
{
	//first set
	...
	AddParallel(new SetRecyclerPosition(up,.8, false)); // bring the bin up to the top [.8 speed up on the last bin
