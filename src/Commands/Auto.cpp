...
Auto::Auto()
{
	...
	//second set
	//AddSequential(new AutoDrive(3, .27,0/* 1.5*/)); // move some distance forwards instead of time // 3in
	...
	AddSequential(new WaveWait(.25)); //Wait a bit to get under the Bin
	...
	AddSequential(new AutoDrive(84, .75, 90));
